...
# =========================================
# Muksta Clone 로컬 배포 스크립트 (테스트용)
# =========================================
# ⚠️ 주의: 이 파일은 로컬 개발/테스트 전용입니다!
# 
# 실제 서버 배포는:
# 1. GitHub Actions (.github/workflows/deploy.yml)가 자동으로 처리
# 2. 서버의 /var/www/muksta/deploy.sh는 GitHub Actions가 생성/관리
# 3. 이 파일을 서버에서 직접 실행하지 마세요!
...
# 배포 시작
echo "========================================="
echo "🚀 Muksta Clone Deployment (Local Test)"
echo "========================================="
